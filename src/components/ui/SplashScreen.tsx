    ...
    >
      ...
      <div style={{
        ...
        <div style={{
          ...
          borderRadius: '50%',
          background: 'radial-gradient(circle, #2D8A5F 0%, transparent 70%)',
          opacity: 0.08,
        ...
        <div style={{
          ...
          borderRadius: '50%',
          background: 'radial-gradient(circle, #5BAF85 0%, transparent 70%)',
          opacity: 0.07,
      ...
      <div style={{
        ...
        {/* リーフアイコン */}
        <div style={{
          filter: 'drop-shadow(0 8px 24px rgba(45,138,95,0.28)) drop-shadow(0 2px 6px rgba(45,138,95,0.16))',
          marginBottom: '16px',
        }}>
