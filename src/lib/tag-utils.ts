 ...
 */
export function countTags(tagArrays: (string[] | null | undefined)[]): Record<string, number> {
 ...
 */
export function topTagsText(counts: Record<string, number>, limit: number): string {
